    ...
    <div class = "w-screen h-screen flex overflow-hidden font-amaticBold">
      ...
      <div class="w-[250px] h-full bg-gray-200 text-center text-white top-0 left-0 overflow-y-auto">
       <div class ="h-[50px] bg-gray-900 flex justify-start items-center">
          <div class="px-[20px]">
        <h3 class="font-bold text-xl">RedCarpet Dashboard</h3>
      </div>
       ...
       <div class="h-[calc(100vh-50px)] bg-gray-800 py-[20px]">
        <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px]">
          <div class=" flex flex-col justify-between space-y-[10px]">
            <router-link to="/dashboard" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-200 hover:text-gray-800  transition duration-400 ease-in-out">
              <img aria-hidden="true" class="mr-2 w-[25px] h-[25px] fill-current" fill="currentColor" viewBox="0 0 20 20" src="/img/stats.png">
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd"></path>
              </img>
              Home
            </router-link>
            <router-link to="/manage-events" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
            ...
            <router-link to="/event-calendar" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md rounded-b-lg hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
            ...
            <router-link to="/manage-outfits" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
            ...
            <router-link to="/manage-users" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
              <img aria-hidden="true" class="mr-2 w-[25px] h-[25px] fill-current" fill="currentColor" viewBox="0 0 20 20" src="/img/manage-user.png">
                <path fill-rule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v7h-2l-1 2H8l-1-2H5V5z" clip-rule="evenodd"></path>
              </img>
              Manage Users
            </router-link>
            <router-link to="/upload-gallery" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
          ...
          <div class="h-[50px]">
            <div>
              <router-link to="/settings" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-amaticBold font-semibold rounded-md border-gray-200 hover:bg-gray-300 hover:text-gray-800  transition duration-400 ease-in-out">
      ...
      <div class ="w-full h-full bg-gray-500 text-center">
        <div class ="h-[50px] bg-gray-200 flex items-center shadow-xl px-[20px] w-full py-[10px] z-10 border-b">
        <!--Hamburger Menu-->
